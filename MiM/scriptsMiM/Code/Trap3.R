...
plot (x=Trampa3$`END DATA`, y= Trampa3$NUMBER)
plot (x=Trampa3$`END DATA`, y= Trampa3$CORREGIDO)
#regresión lineal
Aed0 <- lm(Trampa3$`END DATA`~ Trampa3$NUMBER, data = Trampa3)
Aed0
#regresión lineal versión corregida
Aed0corregido <- lm(Trampa3$`END DATA`~ Trampa3$CORREGIDO, data = Trampa3)
Aed0corregido
...
plot(x = F0, y = E0, xlab = "Fitted values", ylab = "Residuals",
     cex.lab = 1.5)
abline(h = 0, lty = 2)
plot(x = Trampa3$`END DATA`, y = Trampa3$NUMBER, xlab = "Date (months)",
     ylab = "Abundance of Aedes albopictus in Trap 3", cex.lab = 1.5, pch = 16)
abline(Aed0, lwd = 5)
...
plot(x = F0c, y = E0c, xlab = "Fitted values", ylab = "Residuals",
     cex.lab = 1.5)
abline(h = 0, lty = 2)
plot(x = Trampa3$`END DATA`, y = Trampa3$CORREGIDO, xlab = "Date (months)",
     ylab = "Abundance of Aedes albopictus in Trap 3", cex.lab = 1.5, pch = 16)
abline(Aed0corregido, lwd = 5)
#otras herramientas de evaluación
par(mfrow = c(2, 2), mar = c(5, 5, 3, 2))
plot(x = Trampa3$`END DATA`, y = E0, xlab = "Date (months)", ylab = "Residuals",
     cex.lab = 1.5)
abline(h = 0, lty = 2)
boxplot(E0 ~ Trampa3$NUMBER, data = Trampa3, cex.lab = 1.5, xlab = "Trampa3",
        ylab = "Residuals")
#versión corregida
par(mfrow = c(2, 2), mar = c(5, 5, 3, 2))
plot(x = Trampa3$`END DATA`, y = E0c, xlab = "Date (months)", ylab = "Residuals",
     cex.lab = 1.5)
abline(h = 0, lty = 2)
boxplot(E0c ~ Trampa3$CORREGIDO, data = Trampa3, cex.lab = 1.5, xlab = "Trampa3",
        ylab = "Residuals")
...
#Modelo de Poisson
library(poisson)
Aedpoisson <- glm(Trampa3$NUMBER ~ 1, data = Trampa3, family = poisson)
Aedpoisson

AedpoissonC <- glm(Trampa3$CORREGIDO ~ 1, data = Trampa3, family = poisson)
AedpoissonC

Aedpoisson.nulo <- glm(Trampa3$NUMBER ~ 1, data = Trampa3, family = poisson)
...
Aedpoissonc.nulo <- glm(Trampa3$CORREGIDO ~ 1, data = Trampa3, family = poisson)
anova(AedpoissonC, Aedpoissonc.nulo, test = "Chisq")

anova(Aedpoisson, test = "Chisq")
anova(AedpoissonC, test = "Chisq")

#valores ajustados -> función exponencial de Trampa3$CORREGIDO
par(mar = c(5, 5, 2, 2))
Trampa3 <- data.frame(Trampa3$CORREGIDO = seq(0.804, 4.865, length = 25))
P1 <- predict(AedpoissonC, newdata = Trampa3, type = "response")
plot(x = Trampa3$`END DATA`, y = Trampa3$CORREGIDO, ylim = c(0, 300),
     xlab = "Date (months)", ylab = "Total abundance Aedes albopictus",
     cex.lab = 1)
lines(Trampa3$CORREGIDO, P1, lwd = 3)
...
plot(x = eta, y = E1, xlab = "Eta", ylab = "Pearson residuals",
     cex.lab = 1.5)
abline(h = 0, v = 0, lty = 2)
plot(x = Trampa3$`END DATA`, y = E1, xlab = "Date (months)", ylab = "Pearson residuals",
     cex.lab = 1.5, pch = 16)
abline(h = 0, v = 0, lty = 2)
boxplot(E1 ~ Trampa3$NUMBER, ylab = "Pearson residuals", data = Trampa3,
